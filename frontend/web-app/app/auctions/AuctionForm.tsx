    ...
    return (
        <form className='flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className='grid grid-cols-2 gap-3'>
                <Input label='Year' name='year' control={control} rules={{ required: 'Year is requred' }} type='number' />
            ...
            <>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <Input label='Reserve Price (enter 0 if no reserve)' name='reservePrice' control={control} rules={{ required: 'Reserve price is requred' }} type='number' />
                    <DateInput
